...
#
# Some changes were made to work with single cells:
...
path = '/Users/katzlab_agnes/Desktop/conserved_genes/smart_conserved_genes/calculating_BL/' 				# This is the folder that is the parent
...
for t in os.listdir('%s' % path2):		# Take each file in the folder that have the trees
	...
	if 'OG5' in t:						# Consider only the files that contain the word 'OG5'.
		...
		if len(taxon_names_mod2) > 4:					# We are only considering trees with at least 4 minor clades 
